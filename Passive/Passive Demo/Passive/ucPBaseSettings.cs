...
namespace ADSDKDemo
{
    public partial class ucPBaseSettings : UserControl
    {
        ...
        public void ChangeLanguage()
        {
            ...
            grbOutType.Visible = IniSettings.Communication == IniSettings.CommType.USB;
        }
            ...
            switch (Data.Code)
            {
                case PassiveRcp.RCP_CMD_PARA:
                    ...
                    else if (Data.Type == 0)
                    {
                        ...
                        if (IniSettings.Communication == IniSettings.CommType.USB || grbOutType.Visible)
                        {
        ...
        {
            PassiveCommand.SetProgarm(SystemPub.ADRcp);
        ...
        private void ucPBaseSettings_Enter(object sender, EventArgs e)
        {
            ChangeLanguage();
        }

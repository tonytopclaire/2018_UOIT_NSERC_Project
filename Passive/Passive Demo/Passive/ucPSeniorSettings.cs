...
namespace ADSDKDemo
{
    public partial class ucPSeniorSettings : UserControl
    {
        ...
        private void btnReset_Click(object sender, EventArgs e)
        {
            ((Button)sender).Enabled = false;
            Application.DoEvents();
            PassiveCommand.Reset(SystemPub.ADRcp);
        ...
        private void btnIO1Open_Click(object sender, EventArgs e)
        {
            ((Button)sender).Enabled = false;
            Application.DoEvents();
            PassiveCommand.Remote(SystemPub.ADRcp, 1, 1);
        ...
        private void btnIO1Close_Click(object sender, EventArgs e)
        {
            ((Button)sender).Enabled = false;
            Application.DoEvents();
            PassiveCommand.Remote(SystemPub.ADRcp, 1, 0);
        ...
        private void btnIO2Open_Click(object sender, EventArgs e)
        {
            ((Button)sender).Enabled = false;
            Application.DoEvents();
            PassiveCommand.Remote(SystemPub.ADRcp, 2, 1);
        ...
        private void ucPSeniorSettings_Enter(object sender, EventArgs e)
        {
            ChangeLanguage();
            txtOldAddr.Text = SystemPub.ADRcp.Address.ToString();
        }

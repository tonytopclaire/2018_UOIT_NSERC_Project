...
namespace ADSDKDemo
{
    public partial class frmConnect : Form
    {
        ...
        {
            IniSettings.Communication = (IniSettings.CommType)type;
            ...
            {
                case IniSettings.CommType.SERIAL:
                    rdbSerial.Checked = true;
                    rdbSerial.ForeColor = Color.Blue;
                    break;
                case IniSettings.CommType.NET:
                    rdbNet.Checked = true;
                    rdbNet.ForeColor = Color.Blue;
                    break;
                case IniSettings.CommType.USB:
        ...
        private void btnConnected_Click(object sender, EventArgs e)
        {
            ...
            if (!SystemPub.ADRcp.bConnected)
            {
                if (IniSettings.Communication == IniSettings.CommType.NET)
                {

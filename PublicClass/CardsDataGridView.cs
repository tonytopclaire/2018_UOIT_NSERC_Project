...
namespace ADSDK.Device.Reader
{
    public partial class CardsDataGridView : UserControl
    {
        ...
        private string GetShortCard(string datastring)
        {
            ...
            long lngCard = ConvertData.HexStringToDecLong(datastring, cmbStartPoint.SelectedIndex < 0 ? 0 : cmbStartPoint.SelectedIndex, chkIsFour.Checked);
            long wgCard = ConvertData.HexStringToWGLong(datastring, cmbStartPoint.SelectedIndex < 0 ? 0 : cmbStartPoint.SelectedIndex, chkIsFour.Checked);
            string strCard =  ConvertData.DecLongToHexString(lngCard, chkIsFour.Checked);
